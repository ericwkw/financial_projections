...
interface PlanManagerProps {
  ...
  paymentProcessingRate: number; // New Prop for context awareness
  onAdd: () => void;
  onUpdate: (id: string, field: keyof Plan, value: any) => void;
  onDelete: (id: string) => void;
}

const PlanManager: React.FC<PlanManagerProps> = ({ plans, globalCac, paymentProcessingRate, onAdd, onUpdate, onDelete }) => {
          ...
          >
              ...
              <div className="flex gap-2">
                  <div className="relative w-2/3">
                    <input
                      ...
                      min="0"
                      value={plan.price}
                      onChange={(e) => onUpdate(plan.id, 'price', Math.max(0, parseFloat(e.target.value) || 0))}
             ...
             <div className="md:col-span-1 space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) => onUpdate(plan.id, 'setupFee', Math.max(0, parseFloat(e.target.value) || 0))}
             ...
             <div className="md:col-span-2 grid grid-cols-2 gap-2">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate(plan.id, 'monthlyGrowth', Math.max(0, parseFloat(e.target.value) || 0))}
              ...
              <div className="flex gap-1">
                  <div className="relative flex-grow">
                    <input
                      ...
                      min="0"
                      value={plan.unitCost}
                      onChange={(e) => onUpdate(plan.id, 'unitCost', Math.max(0, parseFloat(e.target.value) || 0))}
            ...
            <div className="md:col-span-1 space-y-2">
              ...
              <input
                ...
                onChange={(e) => onUpdate(plan.id, 'subscribers', Math.max(0, parseInt(e.target.value) || 0))}

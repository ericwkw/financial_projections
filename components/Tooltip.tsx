...
const Tooltip: React.FC<TooltipProps> = ({ content, className = '', position = 'top', width = 'w-48' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip Popup */}
      <div 
        className={`absolute left-1/2 -translate-x-1/2 ${width} p-3 bg-slate-800 dark:bg-white text-white dark:text-slate-900 text-xs rounded-lg shadow-xl transition-all duration-200 z-[9999] pointer-events-none text-center font-medium leading-relaxed border border-slate-700 dark:border-slate-200
